@php
    $navItems = [
        ...
        ['route' => 'resumes.index', 'match' => 'resumes.index|resumes.create|resumes.edit|resumes.show', 'label' => 'My Resumes', 'icon' => 'M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z'],
        ['route' => 'resumes.from-jd.create', 'match' => 'resumes.from-jd.*', 'label' => 'Resume from JD', 'icon' => 'M13 10V3L4 14h7v7l9-11h-7z'],
